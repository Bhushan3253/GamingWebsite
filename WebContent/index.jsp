      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content">
          ...
          <a href="#">PC </a>
                    ...
                    <div class="cart">
                        <a href="signin" ><i class='bx bxs-cart' ></i></a>
                    </div>
    ...
    <section class="top-categories">
        ...
        <div class="category-container">
            ...
            <div class="category-item">
                <a href="gamepagewithoutuser?db=gamedata&fd=GameImage"><img src="${pageContext.request.contextPath}/assets/Images/games (5).PNG" alt="Games"></a>
                <h4>Games</h4>
                <p>PlayStation, XBOX, Nintendo</p>
            </div>
            <div class="category-item">
               <a href="gameaccessorieswithoutuser?db=accessories&fd=accessories"> <img src="${pageContext.request.contextPath}/assets/Images/assesories.PNG" alt="Gaming Accessories"></a>
